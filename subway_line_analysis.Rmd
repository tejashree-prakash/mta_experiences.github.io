...
complaint_summary <- complaints_long |>
...
# Order complaint types by total frequency (so legend is stable)
...
times <- levels(complaint_summary$time_of_day)
if (is.null(times)) {
...
# Total number of traces = complaints × times
total_traces <- n_traces_per_time * length(times)

# Dropdown buttons to switch between times of day
