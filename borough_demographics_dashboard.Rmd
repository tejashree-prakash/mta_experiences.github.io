...
First, we want to understand the survey respondents by borough. 
```{r}
...
```
<br>Overall, work was reported the most often for primary use of subway across all boroughs. Specifically,
